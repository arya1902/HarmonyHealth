...
<body>
	...
	<br><br>
	<a href="AddProduct.jsp" class="add">Add Product</a>  <a href="SearchProduct.jsp" class="add">Search Product</a>
	<br><br>
	...
	<table border="1">
		...
		<tr>
			...
			<tr>
					...
					<td><a href="EditProductServlet?productid=<%=p.getProductid()%>">Edit</a></td>
			</tr>
			<%
				}
			%>
