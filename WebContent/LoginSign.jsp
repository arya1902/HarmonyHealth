...
<form action="LoginSignServlet" method="post">
		...
		&nbsp;&nbsp;&nbsp;Password:<input type="password" name="pwd" class="text" required="required"><br><br>
		...
		<a href="UserLogin.jsp" class="link">Login</a>
