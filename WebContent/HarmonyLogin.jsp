...
<title>Harmony Health Login </title>
</head>
<style>
body{
...
<div class="box">
<form action="HarmonyLoginServlet" method="post">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID:<input type="text" name="pwd" placeholder="Enter ID" class="txt" required="required"><br><br>
	
	<input type="submit" value="Login" class="btn"><br><br>  
	Don't Have an Account?&nbsp;&nbsp;&nbsp;&nbsp;<a href="HarmonySignUp.jsp">Sign Up</a><br>
